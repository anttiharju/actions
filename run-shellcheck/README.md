...
[![run-shellcheck](https://github.com/anttiharju/actions/actions/workflows/run-shellcheck.yml/badge.svg)](https://github.com/anttiharju/actions/actions/workflows/run-shellcheck.yml)

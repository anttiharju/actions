...
Recommended trigger event is push to the default branch. In that case, you may wish to run [run-mkdocs-build-strict](../run-mkdocs-build-strict/) on pull request events to catch mistakes early.
